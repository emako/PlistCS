...
{
    private string targetXmlPath = "targetXml.plist";
    private string targetBinPath = "targetBin.plist";
    private string sourceXmlPath = "testXml.plist";
    private string sourceBinPath = "testBin.plist";
    private string sourceImage = "testImage.jpg";
